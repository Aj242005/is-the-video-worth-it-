...
def handle_url_and_prompt(yt_object: Yturl) -> List[str]:
    ...
    return response
def whole_workflow( prompt : str, transcripts: str, vector_store : Chroma) -> List[str]:
...
def _workflow( transcripts : str, vector_store : Chroma, prompt : str = "" ) -> List[str]:
